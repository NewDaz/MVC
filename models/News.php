...
class News
{
	...
	*/
    public static function getNewsList() {
        ...
        $result = $db->query('SELECT id, title, short_content FROM news ORDER BY id ASC LIMIT 6');
    ...
    public static function createNews($options)
    {
        ...
        $sql='INSERT INTO news (title,content,short_content) VALUES (:title,:content,:short_content)';
    ...
    public static function updateNewsById($id,$options)
    {
        ...
        $sql="UPDATE news SET title=:title, content=:content,short_content=:short_content WHERE id=:id";
